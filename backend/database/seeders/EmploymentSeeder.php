    ...
    public function run()
    {
        ...
        $post = [
            ...
            [
                ...
                'experience' => '1+ years of data analysis experience',
                'company_id' => $companyId,
                'employer_id' => $employerId,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ...
            [
                ...
                'experience' => '3+ years of network engineering experience',
                'company_id' => $companyId,
                'employer_id' => $employerId,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ...
            [
                ...
                'jobLocation' => 'Penang, Malaysia',
                'locationType' => 'On-site',
                'requirement' => 'Bachelor\'s degree in Design, Human-Computer Interaction, or related field',
            ...
            [
                ...
                'jobLocation' => 'Penang, Malaysia',
                'locationType' => 'On-site',
                'requirement' => 'Bachelor\'s degree in Business, Marketing, or related field',
            ...
            [
                ...
                'jobLocation' => 'Penang, Malaysia',
                'locationType' => 'On-site',
                'requirement' => 'Currently pursuing a degree in Computer Science or related field',
            ...
            [
                ...
                'jobLocation' => 'Penang, Malaysia',
                'locationType' => 'On-site',
                'requirement' => 'Currently pursuing a degree in Statistics, Mathematics, or related field',
                'experience' => 'No prior experience required',
                'company_id' => $companyId,
                'employer_id' => $employerId,
                'created_at' => Carbon::now(),
            ...
            [
                ...
                'jobLocation' => 'Penang, Malaysia',
                'locationType' => 'Hybrid',
                'requirement' => 'Currently pursuing a degree in Marketing, Business, or related field',
                'experience' => 'No prior experience required',
                'company_id' => $companyId,
                'employer_id' => $employerId,
                'created_at' => Carbon::now(),
