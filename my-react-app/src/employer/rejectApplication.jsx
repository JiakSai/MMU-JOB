...
export default function RejectApplication() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/ShowRejectedApplications', {
                    headers: {
                    ...
                    applyList.map((apply) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <span className="bg-red-500 text-white px-4 py-2 rounded-md"> {apply.status}</span>
