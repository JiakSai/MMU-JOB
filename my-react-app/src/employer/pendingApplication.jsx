...
export default function PendingApplication() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/ShowPendingApplications', {
                    headers: {
                    ...
                    applyList.map((apply) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <span className="bg-stone-300 text-white px-4 py-2 rounded-md"> {apply.status}</span>
