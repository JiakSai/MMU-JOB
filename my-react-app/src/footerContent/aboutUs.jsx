            ...
            <div className="mt-20 text-center">
                    ...
                    <div className="grid grid-cols-3 gap-10 pb-2">
                        <div>
                            ...
                            <a href="/userRegister" className="text-[#2471A3] font-medium hover:font-semibold">Join MMU JOB</a>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <a href="/employerRegister" className="text-[#2471A3] font-medium hover:font-semibold">Create Company Profile</a>
                        </div>
                    </div>
                </div>
            </div>
